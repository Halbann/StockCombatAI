// Copied from devOdico/GoodLines by Andreas Vinter-Hviid with some minor changes.
// https://github.com/devOdico/GoodLines
// https://github.com/avwhite
...
public class LineMeshData {
    ...
    public void SetLinesFromPoints(List<List<Vector3>> lines) {
        ...
        triangles = new int[Mathf.Max((totalCount - 1)*9, 0)]; // This over allocates I think?
